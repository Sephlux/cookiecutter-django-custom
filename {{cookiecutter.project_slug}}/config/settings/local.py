...
ALLOWED_HOSTS = ["app.localhost", "www.localhost", "localhost", "0.0.0.0", "127.0.0.1"]  # noqa: S104ALLOWED_HOSTS = ["www.localhost", "app.localhost", "localhost", "0.0.0.0", "127.0.0.1"]  # noqa: S104
